...
reduced_title_dict = {
    ...
    "SPDR® S&P 500 (SPY)": "SPDR S&P 500 ETF(SPY)",
    "ProShares UltraPro Short QQQ (SQQQ)": "Short QQQ ETF(SQQQ)",
    "Invesco QQQ Trust (QQQ)": "Invesco QQQ ETF(QQQ)",
    "iShares Russell 2000 ETF (IWM)": "Russell 2000 ETF(IWM)",
    "iShares China Large-Cap ETF (FXI)": "China Large-Cap ETF(FXI)",
    ...
    "Samsung KODEX 200 ETF (069500)": "KODEX 200 ETF(069500)",
    "Samsung KODEX 200 Total Return ETF (278530)": "KODEX 200 TR ETF(278530)",
    "Samsung KODEX Leverage ETF[Equity-Derivatives] (122630)": "KODEX 레버리지 ETF(122630)",
    "MiraeAsset TIGER 200 ETF (102110)": "TIGER 200 ETF(102110)",
    "MiraeAsset TIGER Secondary Cell ETF (305540)": "TIGER 2차전지테마 ETF(305540)",
}
